  ...
  return (
    <>
      ...
      <header id="hero" className="hero-section text-white text-center">
        <div
          className="container py-5 d-flex flex-column justify-content-center fade-in-up"
          style={{ minHeight: "85vh", position: "relative", zIndex: 1 }}
        >
          <div className="row py-lg-5">
            <div className="col-lg-9 col-md-10 mx-auto">
              ...
              <p className="lead mb-5" style={{ fontSize: "1.3rem" }}>
                Stop wrestling with spreadsheets. InvoiceX helps you create and
              ...
              <p>
                ...
                <button
                  ...
                  className="btn btn-lg btn-accent fw-bold rounded-pill my-2 mx-1 px-5 py-3 pulse-on-hover"
                >
                ...
                <a
                  href="#how-it-works"
                  className="btn btn-lg btn-outline-accent rounded-pill my-2 mx-1 px-5 py-3 glow-effect text-white"
                >
                  Learn More
                </a>
              </p>
      ...
      <section id="how-it-works" className="py-5 dark-section">
      ...
      <section
        id="generate-invoice"
        className="py-5 text-center cta-section text-white"
      >
        <div className="container">
          ...
          <p className="lead mb-4 mx-auto" style={{ maxWidth: "600px" }}>
            ...
            InvoiceX. Start creating professional invoices today – its fast,
            easy, and effective!
          </p>
          <button
            className="btn btn-lg btn-accent fw-bold rounded-pill px-5 py-3 pulse-on-hover"
            onClick={handleActionButton}
          >
      ...
      <footer className="py-5 footer-dark text-white-50">
        <div className="container text-center">
          <Logo />
          <p className="text-white fw-bold mt-2">InvoiceX</p>
          <p className="mb-0">
            &copy; {new Date().getFullYear()} InvoiceX. All Rights Reserved.
          </p>
